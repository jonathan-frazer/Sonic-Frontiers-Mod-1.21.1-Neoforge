...
public class BaseformAttributeModifiers {
    public static final AttributeModifier STEP_UP_SPRINT = new AttributeModifier(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "step_up_sprint"), 1.00F, AttributeModifier.Operation.ADD_VALUE);
