...
public class BaseformAttributeModifiers {
    ...
    public static final AttributeModifier COMBO_GRAVITY = new AttributeModifier(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "combo_gravity"), -1.0, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
    public static final AttributeModifier WATER_RUN_GRAVITY = new AttributeModifier(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "step_up_base"), -1.0, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
