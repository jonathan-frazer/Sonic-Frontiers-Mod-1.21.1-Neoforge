package net.sonicrushxii.beyondthehorizon.sonic.baseform.models;// Made with Blockbench 4.11.1
...
public class Spindash<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BeyondTheHorizon.MOD_ID, "baseform/spindash"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
		Ballform.render(poseStack, buffer, packedLight, packedOverlay, color);
	}
}